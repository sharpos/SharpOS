...
namespace SharpOS.Kernel.ADC
{
	...
	public unsafe struct PCIDevice
	{
		...
		public static PCIDevice* CREATE (uint bus, uint slot, uint fun)
		{
			...
			instance->subClass = (byte)((data >> 16) & 0xFF);
			instance->baseClass = (byte)((data >> 24) & 0xFF);
		...
		public byte SubClass { get { return subClass; } }
		public byte BaseClass { get { return baseClass; } }
