...
namespace SharpOS.Kernel.FileSystem
{
	public unsafe struct INode {
		...
		private const uint UserIDOffset = 2;
		private const uint SizeOffset = 4;
		private const uint AccessTimeOffset = 8;
		private const uint CreatedTimeOffset = 12;
		private const uint ModifiedTimeOffset = 16;
		private const uint DeletedTimeOffset = 20;
		private const uint GroupIDOffset = 24;
		private const uint LinksCountOffset = 26;
		private const uint BlocksOffset = 28;
		private const uint FlagsOffset = 32;
		private const uint FirstOSDependentValueOffset = 36;
		private const uint BlockDataOffset = 40;
		private const uint GenerationOffset = 100;
		private const uint FileACLOffset = 104;
		private const uint DirectoryACLOffset = 108;
		private const uint LastFileFragmentOffset = 112;
		private const uint SecondOSDependentValueOffset = 116;
		public const uint INodeSize = 128;
