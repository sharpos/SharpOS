...
namespace SharpOS
{
    public class Kernel
    {
        ...
        public unsafe static void WriteBrandName(UInt32 value)
        {
            UInt32 eax = 0, ebx = 0, ecx = 0, edx = 0;
        ...
        public static byte attributes = 14;
        public static byte old_attributes = 14;

        public unsafe static void SetAttributes(byte value)
        {
            old_attributes = attributes;
            attributes = value;
        }

        public unsafe static void RestoreAttributes()
        {
